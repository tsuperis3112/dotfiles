...
__git_prompt() {
  ...
  ref=$(git symbolic-ref --short HEAD 2>/dev/null) ||
    ref="tag:$(git describe --tags --exact-match HEAD 2>/dev/null)" ||
    ref="ref:$(git rev-parse --short HEAD 2>/dev/null)" || ref=""
...
__init_git_prompt() {
  if ! git rev-parse --git-dir &>/dev/null || [[ "$(git config --get oh-my-zsh.hide-info 2>/dev/null)" == 1 ]]; then
